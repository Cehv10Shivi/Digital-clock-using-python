...
lb_hr_text= Label(clk,text="HOUR",font =("times 20 bold",20,"bold"),bg="#007587",fg="white")
...
lb_dn = Label(clk,text ="AM",font=("times 20 bold",70,'bold'),bg="#09F0646",fg="white")
lb_dn.place(x=860,y=200,width=150,height=150)
lb_dn_text= Label(clk,text="NOON",font =("times 20 bold",20,"bold"),bg="#09F0646",fg="white")
